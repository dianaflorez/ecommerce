...
class UsersSearch extends Users
{
    ...
    public function rules()
    {
        return [
            ...
            [['name', 'lastname', 'email', 'username', 'password', 'phone', 'document_number', 'cod_country', 'usercode', 'role', 'status', 'active_desc', 'auth_key', 'access_token', 'created_at', 'updated_at'], 'safe'],
        ];
    }
    ...
    public function search($params, $formName = null)
    {
        ...
        $query->andFilterWhere(['ilike', 'name', $this->name])
            ...
            ->andFilterWhere(['ilike', 'document_number', $this->document_number])
