...
<html lang="<?= Yii::$app->language ?>">
   ...
   <body class="off-canvas-sidebar login-page">
      ...
      <div class="wrapper wrapper-full-page">
         ...
         <div class="page-header0 login-page header-filter" filter-color="black" style="padding: 15vh 0 !important; background-size: cover; background-position: top center;">
